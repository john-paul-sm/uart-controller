...
The protocol can be observed like this:

The line is held at a logic high when idle. A transfer starts with a low start bit, followed by data bits, then one or more stop bits.
